...
export const analyzeResume = async (req, res) => {
    try {
        if (!req.file) {
            return res.status(400).json({ meassage : "Resume Required"});
        }
...

{
    ...
    console.log(aiResponse); // Optional: see the AI response in the terminal
...
export const generateQuestion = async (req, res) => {
    ...
    if(questionArray.length === 0 ){
        return res.status(500).json({
            messages: "AI Faield to generated question."
        });
    }
