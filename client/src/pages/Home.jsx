          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                className={`realtive bg-white rounded-3xl 
                  border-2 border-green-300 hover:border-green-500 p-10
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc : "Track Progress With Performances graphs and topic analytics."
                  }
                ].map((item, index) => (
                  <motion.div key={index} 
                  initial={{opacity : 0, y : 30}}
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  
                  {
                    img : creditImg,
                    title : "Credit System",
                    desc : "unlock Premium inteview session easily. "
                  },
                ].map((mode, index) => (
                  <motion.div key={index} 
                  initial={{opacity : 0, y : 30}}
