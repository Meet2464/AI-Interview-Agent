...
const speakText = (text) => {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-100 flex items-center p-4 sm:p-6'>
            ...
            shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
                ...
                {/* Video Section */}
                <div className='w-full flex flex-col items-center lg:w-[35%] bg-white
                ...
                <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
                    ...
                    {!isIntroPhase  && (<div className='bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm mb-4'>
                       ...
                       {!feedback ? (
                        <div className='flex items-center gap-4 mt-6'>
                            ...
                            className='mt-6 bg-emerald-50 border border-emerald-200 p-5 rounded-2xl shadow-sm'>
                                ...
                                py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center
                                gap-1'>
