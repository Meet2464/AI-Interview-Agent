...
import {FaUserTie,FaBriefcase,FaFileUpload,FaMicrophoneAlt,FaChartLine,FaMicroblog,} from "react-icons/fa";
        ...
        <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
            ...
            className='p-12 bg-white'>
                ...
                <div className='space-y-6'>
                    ...
                    whileHover={{scale : 1.03}}
                    whileTap={{scale : 0.95}}
                    className='w-full disable:bg-gray-600 bg-green-600 
