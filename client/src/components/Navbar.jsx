        ...
        <div className='flex items-center gap-6 relative'>
          ...
          <div className='relative'>
            <button onClick={()=>{
              ...
              setShowCreditPopup(false)
            }} className='flex items-center justify-center w-9 h-9 text-white bg-black rounded-full font-semibold' >
            ...
            {showUserPopup && (
              <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border-gray-200 rounded-xl p-4 z-50'>
                ...
                <button onClick={()=>navigate("/history")}
                  className='w-full text-left text-sm text-gray-600'>Interview History</button>

                <button onClick={handleLogout} className='w-full text-left text-sm py-2 flex
                items-center gap-2 text-red-500'>
