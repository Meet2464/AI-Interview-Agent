...
const Step3Report = ({report}) => {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-gray-50 px sm:px-6 
    lg:px-10 py-8'>
        ...
        sm:justify-between gap-4'>
            <div className='mb-10 w-full flex items-start gap-4 '>
                 <button
                    ...
                    hover:shadow-md transition'><FaArrowLeft
            ...
            hover:bg-emerald-700 text-white px-5 py-3 rounded-xl shadow-md 
            transition-all duration-300 font-semibold text-sm sm:text-base 
            whitespace-nowrap self-start sm:self-auto'>Download PDF</button>
        </div>
            ...
            <div className='lg:col-span-2 space-y-6'>
                ...
                <div className='space-y-6'>
                    ...
                    <div key={i} className='border border-gray-200 rounded-xl p-4 sm:p-5'>
                        ...
                        <span className='shrink-0 text-sm font-semibold text-indigo-600 bg-indigo-50 px-2.5 py-1 rounded-full'>
                            {q.score}/10
                        </span>
                        </div>

                        <div className='bg-yellow-50 border border-emerald-100 rounded-lg px-4 py-3 mb-3'>
